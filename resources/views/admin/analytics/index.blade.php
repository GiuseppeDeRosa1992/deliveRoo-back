...
@section('content')
	...
	<head>
		...
		<title>Statistiche Ordini su DeliveRoo</title>
	...
	<body>
		...
		<div class="container p-0">
			...
			<div id="monthlyCharts">
				...
				<canvas id="monthChart" class="my-3 overflow-x-auto"></canvas>
			</div>
				...
				let monthChart = new Chart(ctx, {
					...
					data: {
						...
						datasets: [{
							...
							backgroundColor: ['rgb(255,224,230)', 'rgb(255,236,217)',
								'rgb(255,245,221)', 'rgb(219,242,242)', 'rgb(215,236,251)',
								'rgb(235,224,255)'
							],
							borderWidth: 1
						}]
