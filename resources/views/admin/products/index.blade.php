					...
					<div class="card text-center h-100">
						<div class="card-body p-0 px-2 pb-2 d-flex justify-content-between flex-column">
							<div class="position-relative">
								@if (Str::startsWith($product->image, 'http'))
									<img src="{{ $product->image }}" class="rounded rounded-circle position-absolute mt-4"
										alt="{{ $product->image }}">
								@else
									<img src="{{ asset('storage/' . $product->image) }}" class="rounded rounded-circle position-absolute mt-4">
								@endif
							...
							<div class="row m-0">
								...
								<div class="col-6 p-1">
									<div class="text-center">
										<a style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#modalId{{ $product->id }}">
								...
								<div class="modal fade" id="modalId{{ $product->id }}" tabindex="-1" data-bs-backdrop="static"
